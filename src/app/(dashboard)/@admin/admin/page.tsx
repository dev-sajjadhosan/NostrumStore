  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground italic">Welcome back, Admin. Here is what's happening today.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-7 gap-6">
        ...
        <Card className="col-span-1 lg:col-span-4 shadow-sm border-muted/40">
          <CardHeader>
            ...
            <CardDescription>Visualizing revenue trends for H1 2026</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <div className="flex justify-between text-sm mb-1">
                <span className="flex items-center gap-2"><AlertCircle className="size-4 text-orange-500"/> Seller Verifications</span>
            ...
            <div className="space-y-4 pt-4">
               <div className="flex items-center gap-4 bg-red-50/50 dark:bg-red-950/20 p-3 rounded-lg border border-red-100 dark:border-red-900/30">
                  <div className="bg-red-500 p-2 rounded text-white font-bold text-xs">03</div>
                  <div className="text-sm">
                    <p className="font-semibold text-red-900 dark:text-red-400">New Seller Applications</p>
                    <p className="text-red-700/70 dark:text-red-500/70 text-xs">Awaiting document review</p>
                  </div>
               </div>
               ...
               <div className="flex items-center gap-4 bg-blue-50/50 dark:bg-blue-950/20 p-3 rounded-lg border border-blue-100 dark:border-blue-900/30">
                  <div className="bg-blue-500 p-2 rounded text-white font-bold text-xs">12</div>
                  <div className="text-sm">
                    <p className="font-semibold text-blue-900 dark:text-blue-400">Flagged Reviews</p>
                    <p className="text-blue-700/70 dark:text-blue-500/70 text-xs">Customer complaints to investigate</p>
                  </div>
               </div>
            </div>
          </CardContent>
